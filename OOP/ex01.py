...
# 클래스 용어 : 현실 세계의 사물을 묘사하는 것이고 예시로 설계도, 붕어빵틀이라고 할 수 있다.
# 클래스의 요소 : 멤버변수(필드, 속성), 멤버메서드(기능), 생성자(필수요소)
...
if __name__ == "__main__":
    ...
    # print("myCar1은 색상: %s, 속도 : %dKm"%(myCar1.color, myCar1.speed))
